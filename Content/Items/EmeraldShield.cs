...
{
    public class EmeraldShield : GuardianShield
    {
        public override void SetGuardianDefaults()
        {
            ShieldProjectile = ModContent.ProjectileType<EmeraldShieldProjectile>();
            MaxDurability = 85;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.Emerald, 17);
            recipe.AddTile(TileID.Anvils);
            recipe.Register();
        }
    }

    public class EmeraldShieldProjectile : GuardianShieldProjectile
    {
        public override void SetDefaults()
        {
            TextureName = "EmeraldShieldProjectile";
        ...
        public override void ConstantEffect()
        {
            ...
            vel *= MathHelper.Max( (Projectile.velocity.Length() - 20f) / 5f, 0f);
                int d = Dust.NewDust(Projectile.Center + Projectile.velocity, 2, 2, DustID.GemEmerald, vel.X * -1, vel.Y * -1);
        ...
        public override void StageChangeEffect()
        {
            ...
            for (var i = 0; i < 3; i++)
            {
                Dust.NewDust(Projectile.Center, 4, 4, DustID.GemEmerald);
            }
        }
