...
{
    public class CopperShield : GuardianShield
    {
        public override void SetGuardianDefaults()
        {
            ShieldProjectile = ModContent.ProjectileType<CopperShieldProjectile>();
            MaxDurability = 45;
    ...
    public class CopperShieldProjectile : GuardianShieldProjectile
    {
        public override void SetDefaults()
        {
            TextureName = "CopperShieldProjectile";
        ...
        public override void StageChangeEffect()
        {
            ...
            for (var i = 0; i < 3; i++)
            {
                Dust.NewDust(Projectile.Center, 4, 4, DustID.Copper);
            }
        }
