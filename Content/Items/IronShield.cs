...
{
    public class IronShield : GuardianShield
    {
        public override void SetGuardianDefaults()
        {
            ShieldProjectile = ModContent.ProjectileType<IronShieldProjectile>();
            MaxDurability = 55;
    ...
    public class IronShieldProjectile : GuardianShieldProjectile
    {
        public override void SetDefaults()
        {
            TextureName = "IronShieldProjectile";
        ...
        public override void StageChangeEffect()
        {
            ...
            for (var i = 0; i < 3; i++)
            {
                Dust.NewDust(Projectile.Center, 4, 4, DustID.Iron);
            }
        }
